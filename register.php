  ...
  <div class="main-wrapper">
    <header class="bgHeader2">
      ...
      <div class="registerPage">
          <h2 class="register_txt">REGISTER</h2>
          <form method="POST" id="formInsert" action="register.php">
            <?php include('error.php'); ?>
            <div class="form-login">
              <label class="username">Username:</label>
              <input type="text" class="form-username-control" name="username" value="<?php echo $username ?>">
              <label class="realName">Name:</label>
              <input type="text" class="form-nameReal-control" name="nama">
              <label class="realEmail">Email:</label>
              <input type="text" class="form-email-control" name="email" value="<?php echo $email ?>">
              <label class="password">Password:</label>
              <input type="password" class="form-password-control" name="password_1">
              <label class="confirmPassword">Confirm Password:</label>
              <input type="password" class="form-confirmPassword-control" name="password_2">
              <div class="class-group">
                <label for="level" class="userSelection">Jenis User</label>
                <select id="level" name="level" class="option">
                    <option value="Admin">Admin</option>
                    <option value="User">User</option>
                </select>
            </div>
              <button class="registerSubmit" type="submit" name="reg_user">SUBMIT</button><br>
              <span class="loginAccount_txt"><a href="http://localhost/InventorySystem/login.php">Already have an Account? Login here</a></span><br>
            </div>
            </form>
      </div>
  </header>
