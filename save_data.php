...
<head>
  ...
  <title>Welcome to Table of Inventory System PT.PETROKIMIA GRESIK</title>
...
<body>
  <div class="main-wrapper">
    ...
    <br>
    <a href="http://localhost/InventorySystem/insert_data.php" class="addItembtn">Tambahkan Barang</a>
          ...
          <table>
              <thead>
                  <tr class="row100 head">
                      ...
                      <th class="cell100 column91">Edit</th>
                      <th class="cell100 column101">Delete</th>
                  </tr>
              </thead>
          </table>
      </div>
          ...
          <table>
              <tbody>
                  <tr class="row100 body">
                      <td class="cell100 column111"><?php echo $row["code_unique"]; ?></td>
                      <td class="cell100 column211"><?php echo $row["nama_barang"]; ?></td>
                      <td class="cell100 column311"><?php echo $row["location"]; ?></td>
                      <td class="cell100 column411"><?php echo $row["date"]; ?></td>
                      <td class="cell100 column511"><?php echo $row["id_pic"]; ?></td>
                      <td class="cell100 column611"><?php echo $row["nama_pic"]; ?></td>
                      <td class="cell100 column711"><?php echo $row["status"]; ?></td>
                      <td class="cell100 column811"><a href="edit.php?id=<?php echo $row['id'] ?>">EDIT</td>
                      <td class="cell100 column911"><a href="delete.php?id=<?php echo $row['id'] ?>">HAPUS</td>
                  </tr>
                  <?php
                  $i++;
                }
