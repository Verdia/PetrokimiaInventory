...
<body>
  <div class="main-wrapper">
    ...
    <div style="display: grid;">  
      <h2 class="ed_h2Tambah">Pengembalian Barang</h2>
      <?php
        include('error.php');
        $id = $_GET['id'];
        ...
        ?>
        <form method="POST" action="update_kembali.php" id="formInsert">
        ...
        <div class="form-group">
            ...
            <button class="addItem" type="submit" name="kembali">Save</button>
      </div>
        </form>
        <?php
          }
